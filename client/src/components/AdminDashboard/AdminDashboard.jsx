    ...
    <>
      <nav className="navbar navbar-dark navbar-expand-md pr-3 pl-3 landing_page_navbar">
        <div className="container-fluid">
          <Link to="/dashboard" className="navbar-brand px-2 navbar_title">Fakeproductdetection</Link>
          <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span className="navbar-toggler-icon"></span>
          </button>
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="nav navbar-nav ms-auto px-2 links">
              <li className="nav-item"><Link className="nav-link px-3 navbar_logout"><Button onClick={submitHandler} variant='contained' color='error' endIcon={<LogoutIcon />}>Logout</Button></Link></li>
            </ul>
          </div>
        </div>
      </nav>
      <div className="container-fluid">
        <div className="card my-5 shadow table_card">
